...
print(f"The number of loans = {total_number_loans}")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
total_value = sum(loan_costs)
print(f"Total sum of loans = ${total_value}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amount = ((total_value)/total_number_loans)
print(f"The average Loan Price = ${average_loan_amount}")
...
print(f"The future value = {future_value}")
remaining_months = loan.get("remaining_months")
print(f"The remaining months = {remaining_months}")
...
with open(output_path, 'w',newline='') as csvfile:
    ...
    for inexpensive_loans in loans:
        if inexpensive_loans["loan_price"] <=500:
            csvwriter.writerow(inexpensive_loans.values())
